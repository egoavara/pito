...
export declare const LitProto: Partial<typio<string | number | boolean, string | number | boolean, LitSchema<string | number | boolean>, LitOption>>;
export declare type TypioLit<T extends string | number | boolean> = typio<T, T, LitSchema<T>, LitOption>;
...
export declare const StrProto: Partial<typio<string, string, StrSchema, StrOption>>;
export declare type TypioStr = typio<string, string, StrSchema, StrOption>;
...
export declare const NumProto: Partial<typio<number, number, NumSchema, NumOption>>;
...
export declare const IntProto: Partial<typio<number, number, IntSchema, IntOption>>;
export declare type TypioInt = typio<number, number, IntSchema, IntOption>;
...
export declare const BoolProto: Partial<typio<boolean, boolean, BoolSchema, BoolOption>>;
export declare type TypioBool = typio<boolean, boolean, BoolSchema, BoolOption>;
